...
echo "-----------------    ${MKBOOTIMG} --kernel ${BIMAGE} --ramdisk ${RAMDISK} --board ${CHIP}_${ARCH} --base ${BASE} --kernel_offset ${KERNEL_OFFSET} --ramdisk_offset ${RAMDISK_OFFSET} -o output/boot.img"
